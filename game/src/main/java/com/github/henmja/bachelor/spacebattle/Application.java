...
public class Application {
    private static Spacebattle game;
    private static GameSession gameSession;

    private Application() {
        game = new Spacebattle("Spacebattle");
        createGameSession();
        startGame();
    }
    ...
    private void startGame() {
        ...
        try {
            ...
            AppGameContainer app = new AppGameContainer(new ScalableGame(game, Spacebattle.WIDTH, Spacebattle.HEIGHT));
